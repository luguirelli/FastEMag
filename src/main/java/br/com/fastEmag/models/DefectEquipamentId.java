...
public class DefectEquipamentId implements Serializable {
	...
	public DefectEquipamentId() {

	}

	public DefectEquipamentId(Equipament equipament, Defect defect) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DefectEquipamentId other = (DefectEquipamentId) obj;
		if (defect == null) {
